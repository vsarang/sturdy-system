...
CollisionTree.prototype.addLayer = function() {
  ...
  this.children = [
    ...
    new CollisionTree(new Vector2(centerPos.x, this.pos.y), childDim, this),
    new CollisionTree(new Vector2(this.pos.x, centerPos.y), childDim, this),
    new CollisionTree(centerPos, childDim, this)
  ];
